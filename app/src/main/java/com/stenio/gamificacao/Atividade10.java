...
public class Atividade10 extends AppCompatActivity {
    ...
    String pergunta1 = "CPU";
    String respostaCorreta1 = " Central Processing Unit";
    String[] resposta1 = {"Center","Central","Processing", "Progress","Program","Unit"};
    ////////////////////////////////////////////////////////////////////////////////////////////////

    String pergunta2 = "LAN";
    String respostaCorreta2 = " Local Area Network";
    String[] resposta2 = {"Area","Activaty","Network", "Local","Link","Northbridge"};
    ////////////////////////////////////////////////////////////////////////////////////////////////

    String pergunta3 = "WAN";
    String respostaCorreta3 = " Wide Area Network";
    String[] resposta3 = {"Network","Wire","Accept", "Area","Netgraph","Wide"};
    ////////////////////////////////////////////////////////////////////////////////////////////////

    String pergunta4 = "USB";
    String respostaCorreta4 = " Universal Serial Bus";
    String[] resposta4 = {"Busining","Universal","System", "Bus","Software","Serial"};
    ////////////////////////////////////////////////////////////////////////////////////////////////

    String pergunta5 = "MAN";
    String respostaCorreta5 = " Metropolitan Area Network";
    String[] resposta5 = {"Network","Area","Accept", "Netgraph","Metropolitan","Miles"};
    ////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_atividade10);
    ...
    public void atualizaPerguntas(View view){
        ...
        if(randomico == 5){
            ...
            alertDialog.setTitle(getString(R.string.msg_result) +respostasCorretas );
            ...
            if(vidas < 0){
                ...
                alertDialog.setMessage(getString(R.string.msg_result));
                ...
                if (respostasCorretas > 0 && respostasCorretas <= 4) {
                    alertDialog.setButton(Dialog.BUTTON_NEGATIVE, getString(R.string.msgRetry), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(getApplicationContext(), Atividade10.class);
