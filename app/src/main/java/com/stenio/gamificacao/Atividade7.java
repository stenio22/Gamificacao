...
public class Atividade7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img1.setImageResource(R.drawable.smartfone);
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img2.setImageResource(R.drawable.computer);
        ...
        img3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img3.setImageResource(R.drawable.smartphone);
        ...
        img4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img4.setImageResource(R.drawable.router);
        ...
        img5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img5.setImageResource(R.drawable.projetor);
        ...
        img6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img6.setImageResource(R.drawable.notebook);
        ...
        img7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img7.setImageResource(R.drawable.computador);
        ...
        img8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img8.setImageResource(R.drawable.webcam);
        ...
        img9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img9.setImageResource(R.drawable.webcam);
        ...
        img10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img10.setImageResource(R.drawable.projector);
        ...
        img11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img11.setImageResource(R.drawable.laptop);
        ...
        img12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img12.setImageResource(R.drawable.roteador);
